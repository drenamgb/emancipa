...
<div id="sse3">
  <div id="sses3">
    <ul>
		<li><h2><a href="professores.php?teste=dados_pessoais">Dados Pessoais</a></h2></li>
		<li><h2><a href="professores.php?teste=lista_prof">Professores</a><h2>	</li><P>
		<li> <h2><a href="professores.php?teste=lista_alunos">Alunos</a></h2></li>
		 <li><h2><a href="professores.php?teste=grade">Grade de Horário</a></h2> </li>
		<li><h2><a href="professores.php?teste=cronograma">Vestibulares</a></h2> </li><p>
		<li><h2><a href="professores.php?teste=material">Material de Estudo</a></h2> </li><p>
		<li><h2><a href="professores.php?teste=desempenho">Desempenho</a></h2> </li><p>
		<li><h2><a href="professores.php?teste=eventos">Eventos</a></h2> </li><p>
	   <li><h2><a href="professores.php?teste=contato">Contato</a></h2> </li><p>
	   <li><h2><a href="professores.php?teste=restrita">Área Restrita</a></h2> </li><p>
	</ul>
  </div>
</div>
<br>
...
switch ($x){
	case "dados_pessoais": 
				...
				<table align="center" border="0" class="tabledados" >
				<form method="post" name="formulario" action="atualiza_prof.php"  enctype="multipart/form-date" onsubmit="return validacao();">
					<tr>
					...
					<tr>
						<td><b> Nome: </td>
						<td><input type="text" name="nome" required="required" value='<?php echo $campo['nome'];?>'  size="30" maxlength="30" /></td>
						<td></td><td class="c2">..............</td>
						<td><b>Faculdade: </td>
						<td> <input type="text" name="faculdade" required="required" value='<?php echo $campo['faculdade'];?>' maxlength="30" size="25"/></td>
						<td class="c2">..............</td>
						<td><b>Login: </td>
						<td><input type="text" name="login" required="required"  size="10" value='<?php echo $campo['login'];?>' disabled onkeyup="maskIt(this,event,'##-###-###')" value="RG sem o dígito" maxlength="10"/></td>
					</tr>
					<tr>
						<td><b> Endereço: </td>
						<td><input type="text" name="endereco" required="required" size="30"  value='<?php echo $campo['endereco'];?>' maxlength="40" /></td>
						<td></td><td></td>
						<td><b>Curso: </td>
						<td><input type="text" name="curso" required="required"  value='<?php echo $campo['curso'];?>' size="25" maxlength="30" /></td>
						<td></td>
						<td><b>Senha: </td>
					...
					<tr>
						...
						<td></td><td></td>
						<td><b>Disciplina: </td>
						<td><select name="disciplina" required="required" tabindex="11">
								<option value="<?php echo $campo['disciplina'];?>"><?php echo $campo['disciplina'];?>	</option>
					...
					<tr>
						<td><b>Telefone 1: </td>
						<td colspan="2"><input type="text" name="telefone1" required="required" size="12" value='<?php echo $campo['telefone1'];?>' onkeyup="maskIt(this,event,'(##)####-####')" maxlength=13/>
						</td>
						<td></td>
						<td><b>Memorando: </td>
						<td colspan="9" rowspan="4"><textarea name="memorando" rows=5 cols=40 maxlength="200"  /><?php echo $campo['memorando'];?></textarea></td>
					</tr>
					<tr>
						<td><b>Telefone 2: </td>
						<td colspan="2"><input type="text" name="telefone2" size="12" onkeyup="maskIt(this,event,'(##)####-####')" value='<?php echo $campo['telefone2'];?>'  maxlength=13/>
					...
					<tr>
						<td><b>Celular: </td>
						<td colspan="2"><input type="text" name="celular" required="required" size="12" onkeyup="maskIt(this,event,'(##)####-####')" value='<?php echo $campo['celular'];?>' maxlength=13 value="Sem o número 9" />
						<font size="3px">Sem o nº 9 
						</td>
					</tr>
					<tr>
						<td><b>E-mail: </td>
						<td><input type="text" name="email" required="required" value='<?php echo $campo['email'];?>' size="30" maxlength="40" /></td>
					</tr>
					<tr>	
						<td><b>Data de Nascimento: </td>
						<td><input type="text" name="data" required="required"  onkeyup="maskIt(this,event,'##-##-####')" value='<?php echo $campo['data'];?>' size="10" /></td>
					</tr>
...
<?php break;
	case "lista_prof": ?> 
					<form method="post" action="busca_prof.php" class="tablel">
				...
				$execbanco=mysql_query($sql,$conexao);
						if(mysql_num_rows($execbanco)==0){
							...
							echo"<tr>
								...
								<td class='c1' align='center'>__Faculdade__</td>
								<td class='c1' align='center'>______Curso______</td>
								<td class='c1' align='center'>___Telefone_1__</td>
								<td class='c1' align='center'>___Celular___</td>
								<td class='c1' align='center'>_______E-mail_______</td>
							...
							while($dados=mysql_fetch_array($execbanco)){
								echo"<tr bgcolor='$cor'>
										...
										<img src='fotos_prof/".$dados['foto']."'height='60' width='80'/></td>
		...
		case "lista_alunos":?>
								...
								<form action="lista_alunos.php" class="busc2">
								<input type="submit" Value="Listar Todos os Alunos" style="width:160;height:30"/>
								</form>
...
<?php }}?>			
	...
	<font size="5" color="red"><b>ATENÇÃO </font><font size="4"><br>
	1- O material deve estar em formato: <font color="red"><b>- PDF , ZIP , TXT , WORD, EXCEL ou JPEG</font><br><p>
	2-	Nomes com caracteres especiais, tipo ' ç ~  ´ í ão ` à  ^ ' <font color="red"><u><b>NÃO</b></u></font> 
	estarão disponíveis para DONWLOAD.<br> Ou seja, escreva o nome do arquivo sem acento<p></font>
	3- <font color="blue">LINK</font> de web site também pode ser inserido como <font color="red">MATERIAL DE ESTUDO</font><p></i>
	<p><font size="5" color="red"><u><b>CUIDADO</u><br></font>
	Você pode apagar o material que enviou clicando ao lado no ícone <font color="red">"X"</p>
	<table bordercolor="green">
	<tr>
		<td align="center"><font size="5"><b><u>Enviar um novo material</u></font><p></td>
	</tr>
	<tr>
		<td>
			<form method="post" action="cad_lista.php" enctype="multipart/form-data">
				<b>MATERIAL: <input type="file" name="lista" />
				<b><font color="blue">Site: <input type="text" size="50" name="link" />
				<input type="hidden" name="data" value="<?php echo date("d")."/".date("m")."/".date("Y")?>">
				<input type="hidden" name="hora" value="<?php echo date("H")."h : ".date("i")."s"?>">
				<input type="hidden" name="disciplina" value="<?php echo $campo['disciplina'];?>">
				<input type="hidden" name="professor" value="<?php echo $campo['nome'];?>">
				<td align="right"><input type="reset" value="Limpar" style="width:60;height:25">
				<input type="submit" value="Enviar" style="width:60;height:35"/>
			</form>
		</td>
	</tr>
	</table><p></font>
	...
	<p>
	<?php $disciplina=$campo['disciplina'];
				include("conexao.php");
				$sql="select*from listas where disciplina = '$disciplina' order by cod desc";
				$execbanco=mysql_query($sql,$conexao);
						if(mysql_num_rows($execbanco)==0){
							...
							while($dados=mysql_fetch_array($execbanco)){
								...
								<form method='post' action='deleta_material_professores.php'>
	...
	<div id="eventos">
			<h2>Lista de <font color="red">Eventos</font> agendados da <font color="green">REDE EMANCIPA</h2></font>
				<?php	
				include("conexao.php");
				$sql="select*from eventos  where disponivel='PROFESSORES' or disponivel='TODOS' order by cod desc";
				$execbanco=mysql_query($sql,$conexao);
						if(mysql_num_rows($execbanco)==0){
							...
							echo "<table  border='0'>";
							echo"<tr>
								<td class='c1' align='center'>__DISPONIVEL__</td>
	...
	case"restrita":?>
			<div id="contato">
			<h2><font color="red">ÁREA RESTRIA<br></h2></font><h3>
			Esta área é destinada aos coordenadores.<p><p>
			
		
		<a href="verifica_area_restrita.php" >Acesar Sistema</a>
	</div>
...
<div id="container2" style="height: 400px"></div>
	...
	<table bgcolor="white" bordercolor="black" class="notas">
	<tr>
		<td align="center">
			<table border="1">
			<tr>
			...
			<tr>
				...
				<td colspan="3" align="center"><b>Portentagem
			...
			<tr>
				...
				<td align="center">
					...
					<?php echo $campo['redacao1'];?><br>
					<?php echo $campo['mediasala1'];?>
					<td align="center">
					...
					<?php echo $campo['redacao2'];?><br>
					<?php echo $campo['mediasala2'];?>
					<td align="center">
					...
					<?php echo $campo['redacao3'];?><br>
					<?php echo $campo['mediasala3'];?>
					</tr>
					<tr><td colspan="4">S1 = Simulado 1, S2=Simulado 2</td></tr>
